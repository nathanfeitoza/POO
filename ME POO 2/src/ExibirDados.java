...
public class ExibirDados extends javax.swing.JFrame {
    ...
    protected AlunoView aluno;
    protected ProfessorView professor;
    protected CursoView curso;
    protected RecepcionistaView recepcionista;
    ...
    public ExibirDados() {
        ...
        curso = new CursoView();
        recepcionista = new RecepcionistaView();
    ...
    public void type_exec(int type)
    {
       ...
       switch(type)
       {
           ...
           case 2:
              ...
              try
              {
                listar_dados.setText(professor.ListarDados());
              } catch(Exception e)
              {
                  JOptionPane.showMessageDialog(null, e.getMessage());
              }
           ...
           case 3:
              ...
              try
              {
                  listar_dados.setText(curso.ListarDados());
              } catch(Exception e)
              {
                  JOptionPane.showMessageDialog(null, e.getMessage());
              }
           ...
           default: 
               label_tipo_dados.setText("Recepcionista Cadastrada");
                try
                {
                  listar_dados.setText(recepcionista.ListarDados());
                } catch(Exception e)
                {
                    JOptionPane.showMessageDialog(null, e.getMessage());
                }
