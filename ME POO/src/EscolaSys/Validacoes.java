...
private static final Pattern pattern = Pattern.compile(EMAIL_PATTERN, Pattern.CASE_INSENSITIVE);
    ...
    public void ShowPainel(String mensagem, String mensagemTitulo)
    {
        JEditorPane textArea = new JEditorPane();
        textArea.setContentType("text/html");
        textArea.setText(mensagem); //Corpo do painel
        JScrollPane scrollPane = new JScrollPane(textArea);  
        textArea.setEditable(false);
        textArea.setBorder(null);
        textArea.setBackground(null);
        scrollPane.setPreferredSize( new Dimension( 350, 350 ) );
        JOptionPane.showMessageDialog(null, scrollPane, mensagemTitulo,  
                                               JOptionPane.DEFAULT_OPTION);//SETO O SCROLLPANE NO JOPTIONPANE
    }
}
